...
const ServiceCard = ({ title, index, icon, link }) => {
  return (
        ...
        >
          ...
          >
            <img
              src={icon}
              alt={title}
              className={`w-16 h-16 object-contain hover:scale-110 ${styles.animate}`}
            />
            <h3 className="blue-text-gradient text-[20px] font-bold text-center">
              {title}
            </h3>
          </div>
        </motion.div>
